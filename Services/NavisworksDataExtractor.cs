    ...
    public class NavisworksDataExtractor
    {
            ...
            List<HierarchicalPropertyRecord> results)
        {
            ...
            if (!currentItem.HasGeometry && !hasProperties)
            {
                ...
                {
                    TraverseAndExtractProperties(child, parentId, level + 1, results);
                }
                return;
            }
